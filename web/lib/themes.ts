...
const RAW: Record<ThemeId, Raw> = {
  graphite:{name:"Graphite",surfaceTop:"#131316",surfaceBottom:"#0C0C0E",textPrimary:"#ECEAE4",textSecondary:"#8B8B93",working:"#0A84FF",done:"#30D158",failed:"#FF453A",needsPermission:"#FF9F0A",plan:"#A78BFA",question:"#5AC8FA",needsInputDot:"#FFD60A",agentClaude:"#00D8F6",agentCodex:"#5FD0B0",agentGemini:"#8FB0F9"},
  ...
  warm:{name:"Warm",surfaceTop:"#16110F",surfaceBottom:"#0D0A09",textPrimary:"#F1E8E2",textSecondary:"#A89A92",working:"#6FB0A6",done:"#86C08A",failed:"#E0685C",needsPermission:"#E8A85E",plan:"#B79CC9",question:"#7FB8C9",needsInputDot:"#E9C46A",agentClaude:"#00D8F6",agentCodex:"#9CC2A0",agentGemini:"#A9B8D6"},
